  ...
  useEffect(() => {
    ...
    const step = () => {
      ...
      for (let i = 0; i < particles.length; i++) {
        ...
        ctx.fillStyle = 'rgba(140, 168, 148, 0.6)';
        ctx.fill();
      }
      ...
      for (let i = 0; i < particles.length; i++) {
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (dist < 130) {
            ...
            ctx.moveTo(a.x, a.y);
            ctx.lineTo(b.x, b.y);
            ctx.strokeStyle = `rgba(140, 168, 148, ${0.14 * (1 - dist / 130)})`;
            ctx.lineWidth = 0.6;
            ctx.stroke();
          }
        }
...
const BuildingIllustration = () => {
  ...
  return (
    <svg viewBox="0 0 240 380" className="w-full h-full overflow-visible">
      ...
      <rect x="4" y="352" width="232" height="10" rx="2" fill="#1c2620" />
      <ellipse cx="118" cy="360" rx="92" ry="13" fill="url(#groundShadow)" />

      <g opacity="0.9">
        <rect x="46" y="336" width="4" height="16" fill="#3a2c22" />
        <circle cx="48" cy="330" r="10" fill="#6b8a72" />
        <rect x="190" y="336" width="4" height="16" fill="#3a2c22" />
        <circle cx="192" cy="330" r="10" fill="#6b8a72" />
      </g>

      <rect x="150" y="210" width="58" height="126" rx="3" fill="url(#wingBody)" />
      <rect x="158" y="228" width="14" height="16" rx="1.5" fill="#a8c4b0" className="window-glow" style={{ animationDelay: '1.1s', animationDuration: '5s' }} />
      <rect x="184" y="228" width="14" height="16" rx="1.5" fill="#8CA894" opacity="0.55" className="window-glow" style={{ animationDelay: '2.4s', animationDuration: '4.5s' }} />
      <rect x="158" y="256" width="14" height="16" rx="1.5" fill="#1a2620" />
      <rect x="184" y="256" width="14" height="16" rx="1.5" fill="#a8c4b0" className="window-glow" style={{ animationDelay: '3s', animationDuration: '4.8s' }} />
      ...
      <rect x="34" y="30" width="30" height="16" rx="2" fill="#2a3a32" />
      <rect x="37" y="34" width="4" height="8" fill="#151c18" />
      <rect x="45" y="34" width="4" height="8" fill="#151c18" />
      <rect x="53" y="34" width="4" height="8" fill="#151c18" />
      <rect x="20" y="42" width="162" height="6" fill="#8CA894" opacity="0.2" />
      <line x1="49" y1="30" x2="49" y2="8" stroke="#8CA894" strokeWidth="2" />
      <circle cx="49" cy="8" r="2.5" fill="#7BA88A" className="antenna-blink" />
      <line x1="130" y1="46" x2="130" y2="16" stroke="#7a9a82" strokeWidth="2" />
      <path d="M130,16 L154,22 L130,28 Z" fill="#7BA88A" className="flag-wave" />

      {[112, 166, 220, 274].map((y, i) => (
        <rect key={i} x="20" y={y} width="146" height="3" fill="#8CA894" opacity="0.12" />
      ))}
      ...
      {windows.map((w, i) => (
        <rect
          ...
          height="19"
          rx="1.5"
          fill={w.kind === 'warm' ? '#a8c4b0' : w.kind === 'cool' ? '#8CA894' : '#1a2620'}
      ...
      <path d="M74,296 L132,296 L124,286 L82,286 Z" fill="#7BA88A" opacity="0.85" />
      <line x1="80" y1="296" x2="80" y2="306" stroke="#7BA88A" strokeWidth="1.5" />
      <line x1="126" y1="296" x2="126" y2="306" stroke="#7BA88A" strokeWidth="1.5" />

      <rect x="82" y="300" width="42" height="32" rx="2" fill="#8CA894" opacity="0.5" />
      <line x1="103" y1="300" x2="103" y2="332" stroke="#0f1613" strokeWidth="1.5" />

      <g className="birds-fly" fill="none" stroke="#8CA894" strokeWidth="1.6" strokeLinecap="round" opacity="0.7">
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle, rgba(123,168,138,0.4), rgba(140,168,148,0.18) 45%, transparent 75%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'conic-gradient(from 0deg, transparent 0%, rgba(123,168,138,0.7) 15%, transparent 30%, transparent 70%, rgba(140,168,148,0.7) 85%, transparent 100%)',
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(145deg, rgba(55,70,61,0.85), rgba(20,28,24,0.9))',
          backdropFilter: 'blur(14px)',
          border: '1px solid rgba(123,168,138,0.4)',
          boxShadow:
      ...
      >
        ...
        <img
          ...
          style={{
            filter:
              'drop-shadow(0 2px 6px rgba(0,0,0,0.6)) drop-shadow(0 0 12px rgba(123,168,138,0.2))',
          }}
        />
      </div>
      ...
      <div className="absolute left-1/2 -translate-x-1/2 -bottom-7 flex flex-col items-center pointer-events-none">
        <span
          ...
          style={{
            ...
            color: '#7BA88A',
            opacity: 0.8,
            textShadow: '0 0 12px rgba(123,168,138,0.5)',
          }}
        >
          {label}
        </span>
        <span
          ...
          style={{
            background: 'linear-gradient(90deg, transparent, #7BA88A, transparent)',
          }}
        />
      </div>
    </div>
...
const HomePage = () => {
  ...
  const customStyles = `
    ...
    @keyframes btn-pulse {
      0%, 100% { box-shadow: 0 8px 30px rgba(123,168,138,0.4), 0 0 0 0 rgba(123,168,138,0.4); }
      50% { box-shadow: 0 8px 30px rgba(123,168,138,0.5), 0 0 0 12px rgba(123,168,138,0); }
    }
    ...
    @keyframes diamond-pulse {
      0%, 100% { opacity: 0.6; box-shadow: 0 0 8px rgba(123,168,138,0.5); transform: rotate(45deg) scale(1); }
      50% { opacity: 1; box-shadow: 0 0 20px rgba(123,168,138,0.9); transform: rotate(45deg) scale(1.25); }
    }
  ...
  return (
    <div className="min-h-screen relative overflow-hidden font-sans text-white" style={{ background: '#0a0f0c' }}>
      ...
      <section id="accueil" className="relative min-h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div
            ...
            style={{
              background: 'conic-gradient(from 0deg at 50% 50%, rgba(123,168,138,0.25), transparent 30%, rgba(140,168,148,0.18) 60%, transparent 90%)',
              filter: 'blur(60px)',
            }}
          />
          <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] bg-[#37463D]/20 rounded-full blur-[150px] animate-pulse-glow" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[40vw] h-[40vw] bg-[#37463D]/30 rounded-full blur-[150px] animate-pulse-glow" style={{ animationDelay: '2s' }} />
          <div className="absolute top-[20%] right-[15%] w-[26vw] h-[26vw] bg-[#4a6b55]/[0.1] rounded-full blur-[130px] animate-pulse-glow" style={{ animationDelay: '3.5s' }} />
        </div>
        ...
        <div className="absolute top-6 md:top-8 inset-x-0 z-30 flex justify-center items-center gap-10 md:gap-20 px-6">
          ...
          <div className="relative hidden md:flex items-center gap-3">
            ...
            <span
              ...
              style={{ background: '#8CA894', animationDelay: '0.3s' }}
            />
            <span
              className="star-twinkle absolute -bottom-3 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full"
              style={{ background: '#7BA88A', animationDelay: '1.1s' }}
            />

            {/* Ligne gauche */}
            <span
              className="w-10 h-[1px]"
              style={{ background: 'linear-gradient(90deg, transparent, rgba(123,168,138,0.8))' }}
            />
            {/* Losange central pulsant */}
            <span
              className="diamond-pulse w-1.5 h-1.5 rotate-45"
              style={{
                background: 'linear-gradient(135deg, #7BA88A, #8CA894)',
              }}
            />
            {/* Ligne droite */}
            <span
              className="w-10 h-[1px]"
              style={{ background: 'linear-gradient(90deg, rgba(123,168,138,0.8), transparent)' }}
            />
          </div>
        ...
        <div className="absolute inset-x-0 bottom-0 z-20 px-6 md:px-12 lg:px-20 pb-20 md:pb-24 lg:pb-28">
          <div className="max-w-2xl animate-fade-up delay-300">
            <svg viewBox="0 0 120 16" className="w-24 h-4 mb-4" fill="none" aria-hidden="true">
              <defs>
                <linearGradient id="flourishGrad" x1="0" y1="0" x2="1" y2="0">
                  <stop offset="0%" stopColor="#7BA88A" />
                  <stop offset="100%" stopColor="#8CA894" />
                </linearGradient>
              </defs>
            ...
            <p className="text-[#7BA88A] text-xs md:text-sm mb-3 tracking-[0.3em] uppercase font-semibold">
            ...
            >
              ...
              <span className="bg-gradient-to-r from-white via-[#8CA894] to-[#7BA88A] bg-clip-text text-transparent">
                Réussites
              </span>
            </h1>
            ...
            <a
              ...
              style={{
                background: 'linear-gradient(135deg, #37463D 0%, #7BA88A 100%)',
                boxShadow: '0 8px 30px rgba(55,70,61,0.5)',
              }}
            >
              <span className="shimmer-layer absolute inset-0 rounded-full pointer-events-none" />
              <span className="relative flex items-center justify-center w-6 h-6">
                <Sparkles size={16} style={{ color: '#f0f5f0' }} />
              </span>
              <span
                className="relative text-sm md:text-base font-bold tracking-[0.08em] text-[#f0f5f0]"
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
                Découvrir l'entreprise
              </span>
              <span className="relative flex items-center justify-center w-7 h-7 rounded-full transition-all duration-500 group-hover:bg-white/10">
                <ArrowRight
                  size={16}
        ...
        >
              ...
              >
                <span
                  ...
                  style={{
                    ...
                    border: '1px solid rgba(123,168,138,0.3)',
                    boxShadow: isHovered
                      ? '0 8px 32px rgba(0,0,0,0.5), 0 0 0 1px rgba(123,168,138,0.2), inset 0 1px 0 rgba(255,255,255,0.05)'
                      : '0 4px 16px rgba(0,0,0,0.3)',
                    opacity: isHovered ? 1 : 0,
                    transform: isHovered ? 'translateX(0) scale(1)' : 'translateX(12px) scale(0.92)',
                  }}
                >
                  <item.icon size={14} style={{ color: '#7BA88A' }} />
                  <span
                    className="text-[11px] tracking-[0.2em] uppercase font-semibold"
                    style={{ fontFamily: "'Playfair Display', serif", color: '#e8f0e8' }}
                  >
                    {item.label}
                  </span>
                  <ArrowRight
                ...
                <span
                  ...
                  style={{
                    background: isHovered
                      ? 'linear-gradient(135deg, rgba(123,168,138,0.95), rgba(140,168,148,0.9))'
                      : 'rgba(20,28,24,0.8)',
                    backdropFilter: 'blur(16px)',
                    border: isHovered
                      ? '1px solid rgba(255,255,255,0.3)'
                      : '1px solid rgba(123,168,138,0.25)',
                    boxShadow: isHovered
                      ? '0 0 30px rgba(123,168,138,0.4), 0 8px 24px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.2)'
                      : '0 4px 16px rgba(0,0,0,0.3)',
                ...
                <span
                  ...
                  style={{
                    background: isHovered ? '#7BA88A' : 'rgba(123,168,138,0.3)',
                    boxShadow: isHovered ? '0 0 8px rgba(123,168,138,0.8)' : 'none',
          ...
          <div className="absolute right-5 top-1/2 -translate-y-1/2 h-32 w-[2px] bg-gradient-to-b from-transparent via-[#7BA88A]/20 to-transparent pointer-events-none -z-10" />
        </nav>
      </section>
      ...
      <div className="lg:hidden fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
            ...
            {NAV_ITEMS.map((item, i) => (
              ...
              >
                <span
                  ...
                  style={{
                    background: 'linear-gradient(135deg, rgba(123,168,138,0.25), rgba(140,168,148,0.18))',
                    border: '1px solid rgba(123,168,138,0.25)',
                  }}
                >
                  <item.icon size={14} style={{ color: '#7BA88A' }} />
                </span>
                ...
                <ArrowRight size={12} className="text-[#8CA894] ml-1" />
              </button>
            ))}
          </div>
        )}
        ...
        <button
          ...
          style={{
            background: mobileNavOpen
              ? 'linear-gradient(135deg, #1a2420, #2a3a32)'
              : 'linear-gradient(135deg, #37463D, #7BA88A)',
            boxShadow: mobileNavOpen
              ? '0 4px 20px rgba(0,0,0,0.5)'
              : '0 6px 28px rgba(123,168,138,0.4)',
        ...
        >
          ...
          />
          {mobileNavOpen ? (
            <X size={20} style={{ color: '#7BA88A' }} className="relative" />
          ) : (
            <Menu size={20} style={{ color: '#f0f5f0' }} className="relative" />
          )}
        </button>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => setActivePage(null)}>
          ...
          <div
            ...
            style={{
              ...
              backdropFilter: 'blur(20px)',
              border: '1px solid rgba(140,168,148,0.3)',
              boxShadow: '0 25px 60px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.05)',
            }}
            onClick={(e) => e.stopPropagation()}
          >
            <div className="absolute top-0 left-0 right-0 h-[2px]" style={{ background: 'linear-gradient(90deg, transparent, #8CA894, transparent)' }} />
            <div className="absolute bottom-0 left-0 right-0 h-[2px]" style={{ background: 'linear-gradient(90deg, transparent, rgba(140,168,148,0.4), transparent)' }} />
            ...
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 30px rgba(123,168,138,0.2)',
              }}
            >
              <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #7BA88A, #4a6b55)', boxShadow: '0 4px 15px rgba(123,168,138,0.4)' }}>
            ...
            <button
              ...
              style={{
                background: 'linear-gradient(135deg, #37463D, #7BA88A)',
                color: '#f0f5f0',
                boxShadow: '0 4px 20px rgba(55,70,61,0.5)',
              }}
            >
              Fermer
            </button>
